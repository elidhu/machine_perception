...
# explosive
exemplar = './sample_data/orb/label-1_3-explosive.png'
test = './sample_data/orb/P1380523.JPG'

# flame
# exemplar = './sample_data/orb/label-2-flammable-gas.png'
# test = './sample_data/orb/P1380490.JPG'

MIN_MATCH_COUNT = 4

## Create ORB object and BF object(using HAMMING)
# orb = cv2.ORB_create()
img1 = cv2.imread(exemplar)
img2 = cv2.imread(test)



orb.quick_orb(img2, img1)
